...
- Presentación principal: `../Leccion04/index.html`.
- Referencia principal: `../Leccion03/index.html`; conservar paleta, tipografía, espaciado, cards, footer, contador, progreso, controles de fuente, fullscreen, teclado, clic/touch y hash numérico.
...
- Actividades orales/A-B: crear HTML independiente en `../Leccion04/workbook/leccion-04/`, siguiendo las actividades de `../Leccion03/workbook/leccion-03/`. Mantener pareja, Alumno A/B, information gap, “NO ENSEÑES TU PANTALLA”, participación de ambos y modo profesor con código `555` cuando aplique.
...
- Medios: guardar en `../Leccion04/assets/<tipo>/` y referenciar desde la presentación como `assets/<tipo>/<archivo>`.
